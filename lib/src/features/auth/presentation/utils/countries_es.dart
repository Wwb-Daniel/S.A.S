// Lista completa de países en Español (ISO 3166-1 alpha-2)
// code: código ISO-2, name: nombre del país
// Nota: nombres adaptados al español común
const List<Map<String, String>> countriesEs = [
